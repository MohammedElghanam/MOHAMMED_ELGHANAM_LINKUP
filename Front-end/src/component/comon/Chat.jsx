        ...
        <div className="flex flex-col h-full bg-gray-100 bg-opacity-5">
                ...
                {messages.map((msg, index) => (
                    msg.senderId === 'myUserId' ? (
                        ...
                        <div className="w-10 h-10">
                            <img className="rounded-full" src="/default.jpg" alt="User Avatar" />
                        </div>
                        </div>
                    ) : (
            ...
            <div className="px-4 py-2 border-t border-gray-500 flex gap-2">
                <div className="flex-1 relative ">
                    <input value={newMessage} onChange={(e) => setNewMessage(e.target.value)} type="text" className=" w-full border border-gray-500 p-2 rounded bg-gray-50 bg-opacity-0" placeholder="Write a message..." />
                ...
                <div className=" flex justify-center items-center gap-1">
                    ...
                    <button onClick={sendMessage} className="ml-2 p-2 rounded flex justify-center items-center text-[#FF00A6]" > <i class="fa-solid fa-paper-plane fa-lg"></i> </button>
                </div>
            </div>
